...
namespace WebApi.Controllers
{
    ...
    public class PessoaJuridicaController : ControllerBase
    {
        ...
        private readonly IPessoaJuridicaService _servico;

        public PessoaJuridicaController(IPessoaJuridicaService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] PessoaJuridicaInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] PessoaJuridicaUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
