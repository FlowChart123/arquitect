...
namespace WebApi.Controllers
{
    ...
    public class PessoaEnderecoController : ControllerBase
    {
        ...
        private readonly IPessoaEnderecoService _servico;

        public PessoaEnderecoController(IPessoaEnderecoService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] PessoaEnderecoInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] PessoaEnderecoUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
