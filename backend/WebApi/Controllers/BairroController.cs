...
namespace WebApi.Controllers
{
    ...
    public class BairroController : ControllerBase
    {
        ...
        private readonly IBairroService _servico;

        public BairroController(IBairroService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] BairroInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] BairroUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
