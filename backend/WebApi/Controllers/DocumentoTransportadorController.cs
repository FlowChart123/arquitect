...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class DocumentoTransportadorController : ControllerBase
    {

        private readonly IDocumentoTransportadorService _servico;

        public DocumentoTransportadorController(IDocumentoTransportadorService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] DocumentoTransportadorInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] DocumentoTransportadorUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
