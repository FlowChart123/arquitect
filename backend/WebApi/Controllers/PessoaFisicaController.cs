...
namespace WebApi.Controllers
{
    ...
    public class PessoaFisicaController : ControllerBase
    {
        ...
        private readonly IPessoaFisicaService _servico;

        public PessoaFisicaController(IPessoaFisicaService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] PessoaFisicaInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] PessoaFisicaUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
