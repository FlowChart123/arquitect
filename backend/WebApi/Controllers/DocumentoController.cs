...
namespace WebApi.Controllers
{
    ...
    public class DocumentoController : ControllerBase
    {
        ...
        private readonly IDocumentoService _servico;

        public DocumentoController(IDocumentoService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] DocumentoInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] DocumentoUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
