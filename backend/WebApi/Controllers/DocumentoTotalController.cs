...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class DocumentoTotalController : ControllerBase
    {

        private readonly IDocumentoTotalService _servico;

        public DocumentoTotalController(IDocumentoTotalService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] DocumentoTotalInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] DocumentoTotalUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
