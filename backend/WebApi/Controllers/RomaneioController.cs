...
namespace WebApi.Controllers
{
    ...
    public class RomaneioController : ControllerBase
    {
        ...
        private readonly IRomaneioService _servico;

        public RomaneioController(IRomaneioService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] RomaneioInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] RomaneioUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
