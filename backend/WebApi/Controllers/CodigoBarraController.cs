...
namespace WebApi.Controllers
{
    ...
    public class CodigoBarraController : ControllerBase
    {
        ...
        private readonly ICodigoBarraService _servico;

        public CodigoBarraController(ICodigoBarraService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] CodigoBarraInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] CodigoBarraUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
