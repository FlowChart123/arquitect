...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class RomaneioDocumentoController : ControllerBase
    {

        private readonly IRomaneioDocumentoService _servico;

        public RomaneioDocumentoController(IRomaneioDocumentoService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] RomaneioDocumentoInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] RomaneioDocumentoUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
