...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class RomaneioCargaController : ControllerBase
    {

        private readonly IRomaneioCargaService _servico;

        public RomaneioCargaController(IRomaneioCargaService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] RomaneioCargaInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] RomaneioCargaUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
