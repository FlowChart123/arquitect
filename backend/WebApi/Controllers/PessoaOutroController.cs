...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class PessoaOutroController : ControllerBase
    {

        private readonly IPessoaOutroService _servico;

        public PessoaOutroController(IPessoaOutroService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] PessoaOutroInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] PessoaOutroUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
