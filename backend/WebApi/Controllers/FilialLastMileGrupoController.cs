...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class FilialLastMileGrupoController : ControllerBase
    {

        private readonly IFilialLastMileGrupoService _servico;

        public FilialLastMileGrupoController(IFilialLastMileGrupoService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] FilialLastMileGrupoInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] FilialLastMileGrupoUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
