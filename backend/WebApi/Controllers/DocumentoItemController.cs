...
namespace WebApi.Controllers
{
    ...
    public class DocumentoItemController : ControllerBase
    {
        ...
        private readonly IDocumentoItemService _servico;

        public DocumentoItemController(IDocumentoItemService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] DocumentoItemInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] DocumentoItemUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
