...
namespace WebApi.Controllers
{
    ...
    public class FilialController : ControllerBase
    {
        ...
        private readonly IFilialService _servico;

        public FilialController(IFilialService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] FilialInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] FilialUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
