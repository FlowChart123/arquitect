...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class FilialLastMileGrupoItemController : ControllerBase
    {

        private readonly IFilialLastMileGrupoItemService _servico;

        public FilialLastMileGrupoItemController(IFilialLastMileGrupoItemService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] FilialLastMileGrupoItemInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] FilialLastMileGrupoItemUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
