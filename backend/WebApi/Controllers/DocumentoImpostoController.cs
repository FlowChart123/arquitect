...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class DocumentoImpostoController : ControllerBase
    {

        private readonly IDocumentoImpostoService _servico;

        public DocumentoImpostoController(IDocumentoImpostoService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] DocumentoImpostoInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] DocumentoImpostoUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
