...
namespace WebApi.Controllers
{
    ...
    public class ProdutoController : ControllerBase
    {
        ...
        private readonly IProdutoService _servico;
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] ProdutoInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] ProdutoUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
