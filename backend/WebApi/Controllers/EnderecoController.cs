...
namespace WebApi.Controllers
{
    ...
    public class EnderecoController : ControllerBase
    {
        ...
        private readonly IEnderecoService _servico;

        public EnderecoController(IEnderecoService servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost("Insert")]
        [AllowAnonymous]
        public IActionResult Post([FromBody] EnderecoInsertCommand model)
        {
        ...
        [HttpPut("Update")]
        [AllowAnonymous]
        public IActionResult Put([FromBody] EnderecoUpdateCommand model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
